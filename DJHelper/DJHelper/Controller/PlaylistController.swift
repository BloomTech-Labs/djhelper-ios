...
class PlaylistController {
    ...
    func put(playlist: Playlist, completion: @escaping (Result<Bool, PlaylistError>) -> Void) {
        ...
        let authURL = baseURL.appendingPathComponent("auth")
        let playlistURL = authURL.appendingPathComponent("playlist")
        let eventURL = playlistURL.appendingPathComponent("event")
        let finalURL = eventURL.appendingPathComponent("\(playlist.eventID)")
