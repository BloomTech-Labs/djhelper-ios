...
class SongController {
    ...
    // MARK: - Fetch Playlist for Event
    func fetchPlaylistFromServer(for event: Event, completion: @escaping(Result<[SongRepresentation], EventErrors>) -> Void) {
        let url = baseURL.appendingPathComponent("songs").appendingPathComponent("\(event.eventID)")
